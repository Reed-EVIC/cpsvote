print("2020")
if (!file.exists(here('cps_data', 'cpsnov2020.gz'))) {
  download.file("https://www2.census.gov/programs-surveys/cps/datasets/2020/supp/nov20pub.dat.gz", destfile = here('cps_data', 'cpsnov2020.gz'))
 }
 
 if (!file.exists(here('cps_docs', 'cpsnov2020.pdf'))) {
   download.file("https://www2.census.gov/programs-surveys/cps/techdocs/cpsnov20.pdf", destfile = here('cps_docs', 'cpsnov2020.pdf'))
 }


cpsvrs2020_orig <- readr::read_fwf(here('cps_data', 'cpsnov2020.gz'),
                                   readr::fwf_cols(CPS_YEAR = c(18, 21),
                                                   ...
                                                   CPS_HISP = c(157,158),
                                                   WEIGHT = c(613, 622),
                                                   VRS_VOTE = c(1001, 1002),       #PES1
                                                   VRS_VOTEREG = c(1003, 1004),    #PES2
                                                   VRS_NOREGWHY = c(1005, 1006),   #PES3
                                                   VRS_NOVOTEWHY = c(1007, 1008),  #PES4
                                                   VRS_VBM = c(1009, 1010),        #PES5
                                                   VRS_ELEXDAY = c(1011, 1012),    #PES6
                                                   VRS_REGHOW = c(1013, 1014),     #PES7
                                                   VRS_RESIDENCE = c(1015, 1016))) #PRS8

# set the factors
cpsvrs2020_factored <- cpsvrs2020_orig %>%
  dplyr::transmute(
    CPS_YEAR,
