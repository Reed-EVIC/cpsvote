if (!file.exists(here('raw_data', 'cpsnov2008.zip'))) {
  download.file("https://data.nber.org/cps/cpsnov08.zip", destfile = here('raw_data', 'cpsnov2008.zip'))
}

if (!file.exists(here('docs', 'cpsnov2008.pdf'))) {
  download.file("data.nber.org/cps/cpsnov08.pdf", destfile = here('docs', 'cpsnov2008.pdf'))
}


cpsvrs2008_orig <- readr::read_fwf(here('raw_data', 'cpsnov2008.zip'),
