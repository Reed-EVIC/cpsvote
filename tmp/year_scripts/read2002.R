if (!file.exists(here('raw_data', 'cpsnov2002.zip'))) {
  download.file("https://data.nber.org/cps/cpsnov02.zip", destfile = here('raw_data', 'cpsnov2002.zip'))
}

if (!file.exists(here('docs', 'cpsnov2002.pdf'))) {
  download.file("data.nber.org/cps/cpsnov02.pdf", destfile = here('docs', 'cpsnov2002.pdf'))
}


cpsvrs2002_orig <- readr::read_fwf(here('raw_data', 'cpsnov2002.zip'),
