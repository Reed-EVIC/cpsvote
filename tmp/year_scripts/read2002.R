print("2002")
if (!file.exists(here('cps_data', 'cpsnov2002.zip'))) {
  download.file("https://data.nber.org/cps/cpsnov02.zip", destfile = here('cps_data', 'cpsnov2002.zip'))
}

if (!file.exists(here('cps_docs', 'cpsnov2002.pdf'))) {
  download.file("data.nber.org/cps/cpsnov02.pdf", destfile = here('cps_docs', 'cpsnov2002.pdf'))
}


cpsvrs2002_orig <- readr::read_fwf(here('cps_data', 'cpsnov2002.zip'),
...
# set the factors
cpsvrs2002_factored <- cpsvrs2002_orig %>%
  dplyr::transmute(
    CPS_YEAR,
