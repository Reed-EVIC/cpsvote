print("2004")
if (!file.exists(here('cps_data', 'cpsnov2004.zip'))) {
  download.file("https://data.nber.org/cps/cpsnov04.zip", destfile = here('cps_data', 'cpsnov2004.zip'))
}

if (!file.exists(here('cps_docs', 'cpsnov2004.pdf'))) {
  download.file("data.nber.org/cps/cpsnov04.pdf", destfile = here('cps_docs', 'cpsnov2004.pdf'))
}


cpsvrs2004_orig <- readr::read_fwf(here('cps_data', 'cpsnov2004.zip'),
