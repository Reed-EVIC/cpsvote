# read the file in #####
cpsvrs2018_direct <- readr::read_fwf(here::here('data', 'data2018.txt'),
...
unique(cpsvrs2018_direct$CPS_YEAR) == 2018

# everybody who is OOU for VOTE is OOU for all VRS Qs
not_in_univ <- filter(cpsvrs2018_direct, VRS_VOTE == -1) %>%
  select(starts_with("VRS_"))
all(not_in_univ == -1)

# set the factors #####
cpsvrs2018 <- cpsvrs2018_direct %>%
