# read the file
# start and end locations via 'docs/doc2002.pdf'
cpsvrs2002_orig <- readr::read_fwf(here::here('data', 'data2002.txt'),
  ...
  mutate(CPS_STATE = factor(stringr::str_pad(CPS_STATE, width = 2, side = "left", pad = "0"),
         ...
         VRS_VOTEMETHOD = factor(VRS_VOTEMETHOD, levels = c(1:3, -1, -2, -3, -9),
                          labels = c("In person on election day",
                                     ...
                                     "Refused",
                                     "No Response")),
         VRS_SINCE95 = factor(VRS_SINCE95, levels = c(1:2, -1, -2, -3, -9),
                                 labels = c("Yes",
                                            "No",
                                            "Not in Universe",
                                            "Don't know",
