# read the file in #####
cpsvrs2016_direct <- readr::read_fwf(here::here('data', 'data2016.txt'),
...
unique(cpsvrs2016_direct$CPS_YEAR) == 2016

# everybody who is OOU for VOTE is OOU for all VRS Qs
not_in_univ <- filter(cpsvrs2016_direct, VRS_VOTE == -1) %>%
  select(starts_with("VRS_"))
all(not_in_univ == -1)

# set the factors #####
cpsvrs2016 <- cpsvrs2016_direct %>%
