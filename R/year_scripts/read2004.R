# read the file
# start and end locations via 'docs/doc2004.pdf'
cpsvrs2004_orig <- readr::read_fwf(here::here('data', 'data2004.txt'),
                                   readr::fwf_cols(CPS_YEAR = c(18, 21),
                                                   ...
                                                   WEIGHT = c(579, 588),
                                                   VRS_VOTE = c(834, 835),
                                                   VRS_VOTEREG = c(836, 837),
                                                   VRS_NOREGWHY = c(838, 839),
                                                   VRS_NOVOTEWHY = c(840, 841),
                                                   VRS_VBM = c(842, 843),
                                                   VRS_ELEXDAY = c(844, 845),
                                                   VRS_REGHOW = c(846, 847),
                                                   VRS_RESIDENCE = c(848, 849)))
  ...
  mutate(CPS_STATE = factor(stringr::str_pad(CPS_STATE, width = 2, side = "left", pad = "0"),
         ...
         VRS_ELEXDAY = factor(VRS_ELEXDAY, levels = c(1, 2, -1, -2, -3, -9),
                              labels = c("On election day",
                                         ...
                                         "Refused",
                                         "No Response")),
         VRS_REGHOW = factor(VRS_REGHOW, levels = c(1:8, -1, -2, -3, -9),
