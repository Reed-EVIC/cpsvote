if (!file.exists(here('raw_data', 'cpsnov2006.zip'))) {
  download.file("https://data.nber.org/cps/cpsnov06.zip", destfile = here('raw_data', 'cpsnov2006.zip'))
}

if (!file.exists(here('docs', 'cpsnov2006.pdf'))) {
  download.file("data.nber.org/cps/cpsnov06.pdf", destfile = here('docs', 'cpsnov2006.pdf'))
}


cpsvrs2006_orig <- readr::read_fwf(here('raw_data', 'cpsnov2006.zip'),
