# read the file in #####
cpsvrs2010_direct <- readr::read_fwf(here::here('data', 'data2010.txt'),
...
unique(cpsvrs2010_direct$CPS_YEAR) == 2010

# everybody who is OOU for VOTE is OOU for all VRS Qs
not_in_univ <- filter(cpsvrs2010_direct, VRS_VOTE == -1) %>%
  select(starts_with("VRS_"))
all(not_in_univ == -1)

# set the factors #####
cpsvrs2010 <- cpsvrs2010_direct %>%
