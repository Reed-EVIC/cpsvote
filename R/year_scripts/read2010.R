if (!file.exists(here('raw_data', 'cpsnov2010.zip'))) {
  download.file("https://data.nber.org/cps/cpsnov10.zip", destfile = here('raw_data', 'cpsnov2010.zip'))
}

if (!file.exists(here('docs', 'cpsnov2010.pdf'))) {
  download.file("data.nber.org/cps/cpsnov10.pdf", destfile = here('docs', 'cpsnov2010.pdf'))
}


cpsvrs2010_orig <- readr::read_fwf(here('raw_data', 'cpsnov2010.zip'),
