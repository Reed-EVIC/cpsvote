...
The basic mechanism of reading the CPS depends on two included data sets: 
...
One note: the warning from `cps_read` appears when `join_dfs = TRUE` (which is a default). The intention is to remind the user that variable names change across years, and to urge caution in only joining the correct columns.

This is a simple (unweighted) breakdown of family income responses in 2006 and 2008.
