...
1. *Install the Package*
   ii) `remotes::install_github(https://github.com/Reed-EVIC/cpsvote)`
...
```{r setup, echo = TRUE}
#library(cps)
cpsvote::download_data(years = 2016) # Download the 2016 CPS
cps2016 <- cpsvote::read_cps(years = 2016) # Read in CPS 2016. Ignore the warning since we don't care
