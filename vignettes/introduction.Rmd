...
A related problem with the CPS turnout estimate, documented carefully by Professor Michael McDonald in a 2014 working paper^[Michael McDonald, 2014, "What's Wrong with the CPS?", Paper presented at the Annual Meeting of the American Political Science Association.] and at the [United States Elections Project's CPS Over-Report and Non-Response Bias Correction] (http://www.electproject.org/home/voter-turnout/cps-methodology) page, is that two biases have crept into the CPS over time: one from increasing non-response rates, the second from over-reporting of turnout. 
