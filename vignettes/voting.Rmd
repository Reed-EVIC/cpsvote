...
Third, the CPS changed the way that it asked about _mode of voting_, using a single question from 1996-2002 and two questions from 2004 to present. `cpsvote` creates a consolidated variable, `VRS_VOTEMETHOD_CON`, that codes for Election Day, Early In-Person, and Voting By Mail from 1996-2020.
...
Professor Michael McDonald of the University of Florida helpfully provides guidance on this more complex procedure. [Commentary, Guidelines, and Stata Code](http://www.electproject.org/home/voter-turnout/cps-methodology) is available at the US Elections website. We have adapted this code for `R` and have integrated it into the `cpsvote` package in the function `cps_reweight_turnout()`. 
...
cps_region %>%
  ...
  scale_y_continuous(labels = scales::percent) +
  labs(title = "The Growth of Early Voting, 1996 - 2020", 
...
cps_region %>%
  ...
  scale_x_continuous(breaks = seq(1996, 2020, by = 2)) +
  scale_y_continuous(labels = scales::percent) +
  labs(title = "Regional Use of Vote At Home, 1996 - 2020", 
       subtitle = "Source: Current Population Survey, Voting and Registration Supplement",
       color = "Region") +
  theme(plot.title = element_text(size = 20, family = "Times", 
                                  face = "bold.italic", colour = "red"),
