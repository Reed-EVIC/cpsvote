...
package provides documentation for appropriate use of sample weights to generate statistical estimates and provides tranformations to calculate alternative
sampling weights to account for survey non-response. The package includes multiple vignettes
that illustrate different applications for voting turnout and mode of voting. 
...
The main purpose of `cpsvote` is to ease access to the Current Population Survey's
Voting and Registration Survey, creating a set of output columns that standardize 
the coding of the primary measures related to voting. 
