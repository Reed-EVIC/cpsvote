...
- This is an animated ternary plot made using vote mode data from `cpsvote`. The code that created this in available in the "The Move Away From Election Day Voting in America: The Snowglobe Plot" vignette.
