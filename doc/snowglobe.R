...
png_files %>%
  ...
  image_write(here('vignettes', 'snowglobe.gif'))

system(paste0('magick ', here('vignettes', 'snowglobe.gif'),
              ' -coalesce -layers OptimizeFrame ',
              here('vignettes', 'snowglobe.gif')))

## ----display-gif, echo = FALSE, eval = TRUE, out.width = "100%"---------------
