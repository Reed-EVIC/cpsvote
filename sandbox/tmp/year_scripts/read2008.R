print("2008")
if (!file.exists(here('cps_data', 'cpsnov2008.zip'))) {
  download.file("https://data.nber.org/cps/cpsnov08.zip", destfile = here('cps_data', 'cpsnov2008.zip'))
}

if (!file.exists(here('cps_docs', 'cpsnov2008.pdf'))) {
  download.file("data.nber.org/cps/cpsnov08.pdf", destfile = here('cps_docs', 'cpsnov2008.pdf'))
}


cpsvrs2008_orig <- readr::read_fwf(here('cps_data', 'cpsnov2008.zip'),
