print("2006")
if (!file.exists(here('cps_data', 'cpsnov2006.zip'))) {
  download.file("https://data.nber.org/cps/cpsnov06.zip", destfile = here('cps_data', 'cpsnov2006.zip'))
}

if (!file.exists(here('cps_docs', 'cpsnov2006.pdf'))) {
  download.file("data.nber.org/cps/cpsnov06.pdf", destfile = here('cps_docs', 'cpsnov2006.pdf'))
}


cpsvrs2006_orig <- readr::read_fwf(here('cps_data', 'cpsnov2006.zip'),
...
# set the factors
cpsvrs2006_factored <- cpsvrs2006_orig %>%
  dplyr::transmute(
    CPS_YEAR,
