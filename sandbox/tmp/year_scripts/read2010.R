print("2010")
if (!file.exists(here('cps_data', 'cpsnov2010.zip'))) {
  download.file("https://data.nber.org/cps/cpsnov10.zip", destfile = here('cps_data', 'cpsnov2010.zip'))
}

if (!file.exists(here('cps_docs', 'cpsnov2010.pdf'))) {
  download.file("data.nber.org/cps/cpsnov10.pdf", destfile = here('cps_docs', 'cpsnov2010.pdf'))
}


cpsvrs2010_orig <- readr::read_fwf(here('cps_data', 'cpsnov2010.zip'),
...
# set the factors
cpsvrs2010_factored <- cpsvrs2010_orig %>%
  dplyr::transmute(
    CPS_YEAR,
